    ...
    <section className="py-20 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-white mb-4">Análisis Musical de Tool</h2>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Explora cómo la banda Tool incorpora patrones matemáticos de Fibonacci en sus composiciones, creando
            experiencias musicales únicas y matemáticamente perfectas.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-4 mb-8">
          {toolSongs.map((song) => (
            <Card
              ...
              onClick={() => {
                console.log("Selecting song:", song.id)
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div className="text-center p-3 bg-blue-900/20 rounded-lg">
                    <div className="text-2xl font-bold text-blue-300">{selectedSong.complexity}</div>
                    <div className="text-xs text-gray-400">Complejidad</div>
                  </div>
                  <div className="text-center p-3 bg-green-900/20 rounded-lg">
                    <div className="text-2xl font-bold text-green-300">{selectedSong.fibonacciMoments.length}</div>
