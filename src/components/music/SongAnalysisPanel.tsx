...
import type { ToolSong } from "@/utils/music"
...
const SongAnalysisPanel: React.FC<SongAnalysisPanelProps> = ({
  ...
  // Function to generate YouTube link based on song ID - usando videos que funcionan
  const getYouTubeLink = (songId: string): string => {
    switch (songId) {
      case "lateralus":
        return "https://www.youtube.com/watch?v=Y7JG63IuaWs" // Tool - Lateralus
      case "schism":
        return "https://www.youtube.com/watch?v=80RtBeB61LE" // Tool - Schism
      case "fibonacci": // Forty Six & 2
        return "https://www.youtube.com/watch?v=GIuZUCpm9hc" // Tool - Forty Six & 2
      default:
